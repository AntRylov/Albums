    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_of_tracks', models.IntegerField(max_length=3, verbose_name='Number of tracks')),
                ...
                ('track', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='album_track', to='catalog.track')),
            ],
            options={
                'verbose_name': 'Album',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(max_length=40, on_delete=django.db.models.deletion.CASCADE, related_name='album_singer', to='catalog.album')),
            ],
            options={
                'verbose_name': 'Singer',
        ...
        migrations.AddIndex(
            model_name='album',
            index=models.Index(fields=['created_at'], name='catalog_alb_created_fa0bb7_idx'),
        ),
    ]
